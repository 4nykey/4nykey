...
DESCRIPTION="FLAC input plugin for LAMIP"
...
SRC_URI="http://fondriest.frederic.free.fr/realisations/lamip/files/src/testing/contrib/lamip-inputFLAC_${PV}.tar.bz2"
